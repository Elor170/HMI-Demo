...
export default function KeyboardTester() {
    ...
    const switchKeyboard = () => {
        const selectedIndex = keyboardNames.findIndex(name => name === selectedKeyboard);
    ...
    return (
        <div className={styles.keyboardTester}>
            <Keyboard layout={englishLowerCase} isVisible={selectedKeyboard === 'En-Lower'} />
            <Keyboard layout={englishUpperCase} isVisible={selectedKeyboard === 'En-Upper'} />
            <Keyboard layout={hebrewLayout} isVisible={selectedKeyboard === 'Hebrew'} />
