...
export const englishLowerCase: KeyboardLayout = {
  leftSection: [
    ...
    [
      ...
      { code: "KeyO", view: "o" },
      { code: "KeyP", view: "p" },
      { code: "BracketLeft", view: "[" },
      { code: "BracketRight", view: "]" },
      { code: "Enter" },
    ],
    [
      { code: "CapsLock" },
    ...
    [
      { code: "ShiftLeft", view: "Shift" },
      { code: "IntlBackslash", view: "|" },
      { code: "KeyZ", view: "z" },
      { code: "KeyX", view: "x" },
      { code: "KeyC", view: "c" },
      { code: "KeyV", view: "v" },
      ...
      { code: "Period", view: "." },
      { code: "Slash", view: "/" },
      { code: "ShiftRight", view: "Shift" },
    ],
    [
      { code: "ControlLeft", view: "Control" },
      { code: "MetaLeft", view: "Win" },
      { code: "AltLeft", view: "Alt" },
      { code: "Space", view: "        " },
      { code: "AltRight", view: "Alt" },
      { code: "ControlRight", view: "Control" },
    ],
  ],
  middleSection: [
    ...
    [
      { code: "ArrowLeft", view: "←" },
      { code: "ArrowDown", view: "↓" },
      { code: "ArrowRight", view: "→" },
    ],
  ],
  rightSection: [
    [],
    [
      { code: "NumLock", view: "NumLk" },
      { code: "NumpadDivide", view: "/" },
      { code: "NumpadMultiply", view: "*" },
      { code: "NumpadSubtract", view: "-" },
    ],
    [
      { code: "Numpad7", view: "7" },
      { code: "Numpad8", view: "8" },
    ...
    [
      { code: "Numpad0", view: "0" },
      { code: "NumpadDecimal", view: "." },
      { code: "NumpadEnter", view: "Enter" },
    ],
  ],
};

export const englishUpperCase: KeyboardLayout =
  structuredClone(englishLowerCase);
...
export const layoutToInitState = (layout: KeyboardLayout): KeyboardState => {
  ...
  const codesSatusesArr: Array<[string, boolean]> = flatLayout.map(
    (key: KeyboardKey) => [key.code, false],
  );
